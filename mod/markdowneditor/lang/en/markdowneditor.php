...
$string['privacy:metadata:markdowneditorquickgrade'] = 'Quick grading preference for markdowneditor submissions.';
$string['privacy:metadata:markdowneditor_submissions'] = 'markdowneditor submissions associated with an markdowneditor.';
$string['privacy:metadata:markdowneditor_submissions:userid'] = 'The user ID submitting the markdowneditor submission.';
$string['privacy:metadata:markdowneditor_submissions:timecreated'] = 'The creation date/time of the markdowneditor submission.';
$string['privacy:metadata:markdowneditor_submissions:timemodified'] = 'The modification date/time of the markdowneditor submission.';
$string['privacy:metadata:markdowneditor_submissions:numfiles'] = 'The maximum number of files allowed for the markdowneditor submission.';
$string['privacy:metadata:markdowneditor_submissions:data1'] = 'The onlinetext submitted for the markdowneditor submission.';
$string['privacy:metadata:markdowneditor_submissions:data2'] = 'The tracked status for the markdowneditor submission.';
$string['privacy:metadata:markdowneditor_submissions:grade'] = 'The grade value awarded for the markdowneditor submission.';
$string['privacy:metadata:markdowneditor_submissions:submissioncomment'] = 'The submission comment accompanying the markdowneditor submission.';
