@editor @editor_newedit @texarea @editor_moodleform
Feature: Text area with enable/disable function.
  ...
  Scenario: Check disable Text area editor.
    ...
    Then the "readonly" attribute of "newedit#id_myeditor" "css_element" should be set

  @javascript
  Scenario: Check enable Text area editor.
    When I set the field "mycontrol" to "Enable"
    Then the "readonly" attribute of "newedit#id_myeditor" "css_element" should not be set
