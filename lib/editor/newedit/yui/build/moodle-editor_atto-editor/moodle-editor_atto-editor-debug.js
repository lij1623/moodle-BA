YUI.add('moodle-editor_newedit-editor', function (Y, NAME) {
...
/**
 * The newedit WYSIWG pluggable editor, written for Moodle.
 *
 * @module     moodle-editor_newedit-editor
 * @package    editor_newedit
 * @copyright  2013 Damyon Wiese  <damyon@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @main       moodle-editor_newedit-editor
 */
...
var LOGNAME = 'moodle-editor_newedit-editor';
var CSS = {
        CONTENT: 'editor_newedit_content',
        CONTENTWRAPPER: 'editor_newedit_content_wrap',
        TOOLBAR: 'editor_newedit_toolbar',
        WRAPPER: 'editor_newedit',
        HIGHLIGHT: 'highlight'
    },
    rangy = window.rangy;

/**
 * The newedit editor for Moodle.
 *
 * @namespace M.editor_newedit
 * @class Editor
 * @constructor
 * @uses M.editor_newedit.EditorClean
 * @uses M.editor_newedit.EditorFilepicker
 * @uses M.editor_newedit.EditorSelection
 * @uses M.editor_newedit.EditorStyling
 * @uses M.editor_newedit.EditorTextArea
 * @uses M.editor_newedit.EditorToolbar
 * @uses M.editor_newedit.EditorToolbarNav
 */
...
Y.extend(Editor, Y.Base, {
    ...
    PLACEHOLDER_CLASS: 'newedit-tmp-class',
    ...
    initializer: function() {
        ...
        var description = Y.Node.create('<div class="sr-only">' + M.util.get_string('richtexteditor', 'editor_newedit') + '</div>');
        ...
        this.textarea.get('parentNode').insert(this._wrapper, this.textarea).
                setAttribute('class', 'editor_newedit_wrap');
    ...
    publishEvents: function() {
        ...
        this.publish('newedit:selectionchanged', {
            prefix: 'newedit'
        });
    ...
    setupPlugins: function() {
        ...
        for (groupIndex in plugins) {
            ...
            for (pluginIndex in group.plugins) {
                ...
                if (typeof Y.M['newedit_' + plugin.name] === "undefined") {
                    Y.log("Plugin '" + plugin.name + "' could not be found - skipping initialisation", "warn", LOGNAME);
                    continue;
                }
                this.plugins[plugin.name] = new Y.M['newedit_' + plugin.name].Button(pluginConfig);
            }
        }
...
Y.namespace('M.editor_newedit').Editor = Editor;

// Function for Moodle's initialisation.
Y.namespace('M.editor_newedit.Editor').init = function(config) {
    return new Y.M.editor_newedit.Editor(config);
};
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
...
/**
 * A notify function for the newedit editor.
 *
 * @module     moodle-editor_newedit-notify
 * @submodule  notify
 * @package    editor_newedit
...
var LOGNAME_NOTIFY = 'moodle-editor_newedit-editor-notify',
    NOTIFY_INFO = 'info',
...
EditorNotify.prototype = {
    ...
    /**
     * Show a notification in a floaty overlay somewhere in the newedit editor text area.
     *
     * @method showMessage
    ...
    showMessage: function(message, type, timeout) {
        ...
        if (this.messageOverlay === null) {
            this.messageOverlay = Y.Node.create('<div class="editor_newedit_notification"></div>');
        ...
        // Convert class to newedit_info (for example).
        type = 'newedit_' + type;
        ...
        this.hideTimer = Y.later(intTimeout, this, function() {
            Y.log('Hide newedit notification.', 'debug', LOGNAME_NOTIFY);
            this.hideTimer = null;
...
Y.Base.mix(Y.M.editor_newedit.Editor, [EditorNotify]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * Textarea functions for the newedit editor.
 *
 * See {{#crossLink "M.editor_newedit.Editor"}}{{/crossLink}} for details.
 *
 * @namespace M.editor_newedit
...
Y.Base.mix(Y.M.editor_newedit.Editor, [EditorTextArea]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * A autosave function for the newedit editor.
 *
 * @module     moodle-editor_newedit-autosave
...
var SUCCESS_MESSAGE_TIMEOUT = 5000,
    ...
    LOGNAME_AUTOSAVE = 'moodle-editor_newedit-editor-autosave';
...
EditorAutosave.prototype = {
        ...
        this.autosaveIo(params, this, {
            success: function(response) {
                ...
                if (response.error || typeof response.result === 'undefined') {
                    ...
                    this.showMessage(M.util.get_string('errortextrecovery', 'editor_newedit'),
    ...
    recoverText: function(text) {
        ...
        this.showMessage(M.util.get_string('textrecovered', 'editor_newedit'),
    ...
    saveDraft: function() {
        ...
        if (newText !== this.lastText) {
            ...
            var ajaxErrorFunction = function(response) {
                ...
                this.showMessage(M.util.get_string('autosavefailed', 'editor_newedit'), NOTIFY_WARNING, errorDuration);
            };
            ...
            this.autosaveIo(params, this, {
                ...
                success: function(response) {
                    if (response && response.error) {
                        ...
                        this.showMessage(M.util.get_string('autosavesucceeded', 'editor_newedit'),
...
Y.Base.mix(Y.M.editor_newedit.Editor, [EditorAutosave]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
 ...
 * A autosave function for the newedit editor.
 *
 * @module     moodle-editor_newedit-autosave-io
...
EditorAutosaveIoDispatcher.ATTRS = {
     ...
     * @type String
     * @default '/lib/editor/newedit/autosave-ajax.php'
     * @readOnly
     */
    autosaveAjaxScript: {
        value: '/lib/editor/newedit/autosave-ajax.php',
        readOnly: true
    },
...
Y.Base.mix(Y.M.editor_newedit.Editor, [EditorAutosaveIo]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * Functions for the newedit editor to clean the generated content.
 *
 * See {{#crossLink "M.editor_newedit.Editor"}}{{/crossLink}} for details.
 *
 * @namespace M.editor_newedit
...
EditorClean.prototype = {
    ...
    getCleanHTML: function() {
        ...
        editorClone.all('.newedit_control').remove(true);
    ...
    fallbackPasteCleanup: function() {
        Y.log('Using fallbackPasteCleanup for newedit cleanup', 'debug', LOGNAME);
...
Y.Base.mix(Y.M.editor_newedit.Editor, [EditorClean]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * Selection functions for the newedit editor.
 *
 * See {{#crossLink "M.editor_newedit.Editor"}}{{/crossLink}} for details.
 *
 * @namespace M.editor_newedit
...
Y.Base.mix(Y.M.editor_newedit.Editor, [EditorCommand]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * Toolbar functions for the newedit editor.
 *
 * See {{#crossLink "M.editor_newedit.Editor"}}{{/crossLink}} for details.
 *
 * @namespace M.editor_newedit
...
Y.Base.mix(Y.M.editor_newedit.Editor, [EditorToolbar]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * Toolbar Navigation functions for the newedit editor.
 *
 * See {{#crossLink "M.editor_newedit.Editor"}}{{/crossLink}} for details.
 *
 * @namespace M.editor_newedit
    ...
    checkTabFocus: function() {
        if (this._tabFocus) {
            if (this._tabFocus.hasAttribute('disabled') || this._tabFocus.hasAttribute('hidden')
                    || this._tabFocus.ancestor('.newedit_group').hasAttribute('hidden')) {
...
Y.Base.mix(Y.M.editor_newedit.Editor, [EditorToolbarNav]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
EditorSelection.prototype = {
    ...
    setupSelectionWatchers: function() {
        ...
        this.on('newedit:selectionchanged', this.saveSelection, this);
     ...
     *
     * Should be used in combination with {{#crossLink "M.editor_newedit.EditorSelection/restoreSelection"}}{{/crossLink}}.
     *
     ...
     *
     * Should be used in combination with {{#crossLink "M.editor_newedit.EditorSelection/saveSelection"}}{{/crossLink}}.
     *
     ...
     *
     * If the selection has changed, the newedit:selectionchanged event is also fired.
     *
    ...
    /**
     * Fires the newedit:selectionchanged event.
     *
    ...
    _fireSelectionChanged: function(e) {
        this.fire('newedit:selectionchanged', {
            event: e,
            selectedNodes: this.getSelectedNodes()
        });
    },
...
Y.Base.mix(Y.M.editor_newedit.Editor, [EditorSelection]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * Editor styling functions for the newedit editor.
 *
 * See {{#crossLink "M.editor_newedit.Editor"}}{{/crossLink}} for details.
 *
 * @namespace M.editor_newedit
...
Y.Base.mix(Y.M.editor_newedit.Editor, [EditorStyling]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * Filepicker options for the newedit editor.
 *
 * See {{#crossLink "M.editor_newedit.Editor"}}{{/crossLink}} for details.
 *
 * @namespace M.editor_newedit
...
Y.Base.mix(Y.M.editor_newedit.Editor, [EditorFilepicker]);
