YUI.add('moodle-editor_newedit-menu', function (Y, NAME) {
...
/**
 * A Menu for the newedit editor.
 *
 * @module     moodle-editor_newedit-menu
 * @submodule  menu-base
...
var LOGNAME = 'moodle-editor_newedit-menu';
var MENUDIALOGUE = '' +
        '<div class="open {{config.buttonClass}} newedit_menu" ' +
            ...
            '<ul class="dropdown-menu" role="menu" id="{{config.buttonId}}_menu" aria-labelledby="{{config.buttonId}}">' +
                '{{#each config.items}}' +
                    '<li role="none" class="newedit_menuentry">' +
...
/**
 * A Menu for the newedit editor used in Moodle.
 *
...
Y.extend(Menu, M.core.dialogue, {
    ...
    initializer: function(config) {
        ...
        bb.addClass('editor_newedit_controlmenu');
        bb.addClass('editor_newedit_menu');
    ...
    _setupHandlers: function() {
        ...
        this._menuHandlers.push(
            ...
            contentBox.delegate('key', this._chooseMenuItem, '32, enter', '.newedit_menuentry', this),
...
Y.namespace('M.editor_newedit').Menu = Menu;
