...
class autosave_cleanup_task extends scheduled_task {
    ...
    public function get_name() {
        return get_string('taskautosavecleanup', 'editor_newedit');
    }
    ...
    public function execute() {
        ...
        $DB->delete_records_select('editor_newedit_autosave', 'timemodified < :before', array('before' => $before));
    }
