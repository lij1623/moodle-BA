...
/**
 * Privacy Subsystem implementation for editor_newedit.
 *
...
namespace editor_newedit\privacy;
...
class provider implements
        // The newedit editor stores user provided data.
        \core_privacy\local\metadata\provider,
        // The newedit editor provides data directly to core.
        \core_privacy\local\request\plugin\provider,
        // The newedit editor is capable of determining which users have data within it.
        \core_privacy\local\request\core_userlist_provider {

    /**
     * Returns information about how editor_newedit stores its data.
     *
    ...
    public static function get_metadata(collection $collection) : collection {
        ...
        $collection->add_database_table('editor_newedit_autosave', [
                'userid' => 'privacy:metadata:database:newedit_autosave:userid',
                'drafttext' => 'privacy:metadata:database:newedit_autosave:drafttext',
                'timemodified' => 'privacy:metadata:database:newedit_autosave:timemodified',
            ], 'privacy:metadata:database:newedit_autosave');
    ...
    public static function get_contexts_for_userid(int $userid) : \core_privacy\local\request\contextlist {
        ...
        $sql = "SELECT
                    c.id
                  FROM {editor_newedit_autosave} eas
        ...
        $sql = "SELECT contextid FROM {editor_newedit_autosave} WHERE userid = :userid";
    ...
    protected static function export_autosaves(\stdClass $user, \moodle_recordset $autosaves) {
        foreach ($autosaves as $autosave) {
            ...
            $subcontext = [
                get_string('autosaves', 'editor_newedit'),
                $autosave->id,
            ];
    ...
    public static function delete_data_for_all_users_in_context(\context $context) {
        ...
        $DB->delete_records('editor_newedit_autosave', [
                'contextid' => $context->id,
            ]);
    }
    ...
    public static function delete_data_for_users(approved_userlist $userlist) {
        ...
        $DB->delete_records_select('editor_newedit_autosave', "contextid = :contextid AND userid {$useridsql}",
            $params);
    }
    ...
    public static function delete_data_for_user(approved_contextlist $contextlist) {
        ...
        $sql = "SELECT * FROM {editor_newedit_autosave} WHERE contextid {$contextsql}";
        $autosaves = $DB->delete_records_select('editor_newedit_autosave', "userid = :userid AND contextid {$contextsql}",
                $contextparams);
    }
