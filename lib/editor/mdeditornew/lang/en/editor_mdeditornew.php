...
/**
 * Strings for component 'editor_mdeditornew', language 'en'.
 *
 * @package    editor_mdeditornew
...
$string['autosavefrequency_desc'] = 'This is the number of seconds between auto save attempts. mdeditornew will automatically save the text in the editor according to this setting, so that text can be automatically restored when the same user returns to the same form.';
...
$string['pluginname'] = 'mdeditornew HTML editor';
$string['richtexteditor'] = 'Rich text editor';
$string['subplugintype_mdeditornew'] = 'mdeditornew plugin';
$string['subplugintype_mdeditornew_plural'] = 'mdeditornew plugins';
$string['settings'] = 'mdeditornew toolbar settings';
...
$string['privacy:metadata:database:mdeditornew_autosave'] = 'Automatically saved text editor drafts.';
$string['privacy:metadata:database:mdeditornew_autosave:userid'] = 'The ID of the user whose data was saved.';
$string['privacy:metadata:database:mdeditornew_autosave:drafttext'] = 'The text which was saved.';
$string['privacy:metadata:database:mdeditornew_autosave:timemodified'] = 'The time that content was modified.';
