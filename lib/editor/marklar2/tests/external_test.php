 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class editor_marklar2_external_testcase extends advanced_testcase {

    /**
     * Test the editor_marklar2_get_preview() external function.
     */
    public function test_get_preview() {
        ...
        $response = external_api::clean_returnvalue(editor_marklar2_external::get_preview_returns(),
            editor_marklar2_external::get_preview($text, $format, $contextid));
