 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class editor_marklar2_preferences_form extends moodleform {
    ...
    public function definition() {
        ...
        ], 'formats', get_string('preferencesformat', 'editor_marklar2'), '<br>', false);

        $mform->addHelpButton('formats', 'preferencesformat', 'editor_marklar2');
