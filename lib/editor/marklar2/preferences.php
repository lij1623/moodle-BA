...
$PAGE->set_url('/lib/editor/marklar2/preferences.php', ['id' => $userid]);
$PAGE->navbar->includesettingsbase = true;
$PAGE->set_title($course->shortname.': '.get_string('preferences', 'editor_marklar2'));
$PAGE->set_heading(fullname($user, true));

$form = new editor_marklar2_preferences_form(null, ['user' => $user]);
$data = [];

$formats = json_decode(get_user_preferences('editor_marklar2/formats', null, $user));
...
echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('preferences', 'editor_marklar2'));
$form->display();
echo $OUTPUT->footer();
