...
/**
 * Demonstrates use of mde editor with overridden toolbar setting.
 *
...
require_once($CFG->dirroot . '/lib/editor/mde/lib.php');

// Behat test fixture only.
defined('BEHAT_SITE_RUNNING') || die('Only available on Behat test server');

$PAGE->set_url('/lib/editor/mde/tests/fixtures/override_plugins_example.php');
