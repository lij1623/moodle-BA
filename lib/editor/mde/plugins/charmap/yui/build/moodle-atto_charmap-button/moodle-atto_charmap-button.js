YUI.add('moodle-mde_charmap-button', function (Y, NAME) {
...
/**
 * mde text editor character map plugin
 *
 * @module moodle-mde_charmap-button
 */

var COMPONENTNAME = 'mde_charmap',
    CSS = {
        BUTTON: 'mde_charmap_character',
        CHARMAP: 'mde_charmap_selector'
    },
    /*
...
/**
 * mde text editor charmap plugin.
 *
 * @namespace M.mde_charmap
 * @class button
 * @extends M.editor_mde.EditorPlugin
 */

Y.namespace('M.mde_charmap').Button = Y.Base.create('button', Y.M.editor_mde.EditorPlugin, [], {
    /**
