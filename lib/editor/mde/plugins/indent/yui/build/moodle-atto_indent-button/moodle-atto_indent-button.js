YUI.add('moodle-mde_indent-button', function (Y, NAME) {
...
/**
 * @module     moodle-mde_indent-button
 */

/**
 * mde text editor indent plugin.
 *
 * @namespace M.mde_indent
 * @class button
 * @extends M.editor_mde.EditorPlugin
 */

Y.namespace('M.mde_indent').Button = Y.Base.create('button', Y.M.editor_mde.EditorPlugin, [], {
