YUI.add('moodle-mde_accessibilitychecker-button', function (Y, NAME) {
...
/*
 * @package    mde_accessibilitychecker
 * @copyright  2014 Damyon Wiese  <damyon@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

/**
 * @module moodle-mde_accessibilitychecker-button
 */

/**
 * Accessibility Checking tool for the mde editor.
 *
 * @namespace M.mde_accessibilitychecker
 * @class Button
 * @extends M.editor_mde.EditorPlugin
 */

var COMPONENT = 'mde_accessibilitychecker';

Y.namespace('M.mde_accessibilitychecker').Button = Y.Base.create('button', Y.M.editor_mde.EditorPlugin, [], {
...
}, '@VERSION@', {"requires": ["color-base", "moodle-editor_mde-plugin"]});
