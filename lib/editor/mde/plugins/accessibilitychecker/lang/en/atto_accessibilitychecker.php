...
/**
 * Strings for component 'mde_accessibilitychecker', language 'en'.
 *
...
$string['privacy:metadata'] = 'The mde_accessibilitychecker plugin does not store any personal data.';
