YUI.add('moodle-mde_accessibilityhelper-button', function (Y, NAME) {
...
/*
 * @package    mde_accessibilityhelper
 * @copyright  2014 Damyon Wiese  <damyon@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

/**
 * @module moodle-mde_accessibilityhelper-button
 */

/**
 * mde text editor accessibilityhelper plugin.
 *
 ...
 *
 *
 * @namespace M.mde_accessibilityhelper
 * @class Button
 * @extends M.editor_mde.EditorPlugin
 */

var COMPONENT = 'mde_accessibilityhelper',
    TEMPLATE = '' +
        // The list of styles.
...
Y.namespace('M.mde_accessibilityhelper').Button = Y.Base.create('button', Y.M.editor_mde.EditorPlugin, [], {
