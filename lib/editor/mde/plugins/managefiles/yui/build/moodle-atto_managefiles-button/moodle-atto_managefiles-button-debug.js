YUI.add('moodle-mde_managefiles-button', function (Y, NAME) {
...
/**
 * @module moodle-mde-managefiles-button
 */

/**
 * mde text editor managefiles plugin.
 *
 * @namespace M.mde_link
 * @class button
 * @extends M.editor_mde.EditorPlugin
 */

var LOGNAME = 'mde_managefiles',
    CAN_RECEIVE_FOCUS_SELECTOR = '.fp-navbar a:not([disabled])',
    FILE_MANAGER_SELECTOR = '#fitem_id_files_filemanager';

Y.namespace('M.mde_managefiles').Button = Y.Base.create('button', Y.M.editor_mde.EditorPlugin, [], {
    ...
    _getIframeURL: function() {
        var args = Y.mix({
                ...
                this.get('area'));
        return M.cfg.wwwroot + '/lib/editor/mde/plugins/managefiles/manage.php?' +
