YUI.add('moodle-mde_managefiles-usedfiles', function (Y, NAME) {
...
/**
 * @module moodle-mde_managefiles-usedfiles
 */


/**
 * mde text editor managefiles usedfiles plugin.
 *
 * @namespace M.mde_managefiles
 * @class usedfiles
 */
...
var SELECTORS = {
    FILEANCESTOR: '.fitem',
    FORM: '#mde_managefiles_manageform',
    MISSINGFILES: '.missing-files'
};

M.mde_managefiles = M.mde_managefiles || {};
M.mde_managefiles.usedfiles = M.mde_managefiles.usedfiles || {
    ...
    init: function(config) {
        ...
        if (!form || !window.parent) {
            Y.log("Unable to find parent window", 'warn', 'moodle-mde_managemedia-usedfiles');
            return;
        }
