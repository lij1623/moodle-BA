YUI.add('moodle-mde_collapse-button', function (Y, NAME) {
...
/**
 * @module moodle-mde_collapse-button
 */

/**
 * mde text editor collapse plugin.
 *
 * @namespace M.mde_collapse
 * @class button
 * @extends M.editor_mde.EditorPlugin
 */

var PLUGINNAME = 'mde_collapse',
    ATTRSHOWGROUPS = 'showgroups',
    COLLAPSE = 'collapse',
    COLLAPSED = 'collapsed',
    GROUPS = '.mde_group',
    ROWS = '.mde_toolbar_row';

Y.namespace('M.mde_collapse').Button = Y.Base.create('button', Y.M.editor_mde.EditorPlugin, [], {
    initializer: function() {
        ...
        this.get('host').on('pluginsloaded', function(e, button) {
            ...
            var toolbarRows = [
                Y.Node.create('<div class="mde_toolbar_row" role="group"></div>'),
                Y.Node.create('<div class="mde_toolbar_row" role="group" aria-label="' +
