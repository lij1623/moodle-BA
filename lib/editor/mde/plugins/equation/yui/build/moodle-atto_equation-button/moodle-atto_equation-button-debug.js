YUI.add('moodle-mde_equation-button', function (Y, NAME) {
...
/**
 * mde text editor equation plugin.
 */

/**
 * mde equation editor.
 *
 * @namespace M.mde_equation
 * @class Button
 * @extends M.editor_mde.EditorPlugin
 */
var COMPONENTNAME = 'mde_equation',
    LOGNAME = 'mde_equation',
    CSS = {
        EQUATION_TEXT: 'mde_equation_equation',
        EQUATION_PREVIEW: 'mde_equation_preview',
        SUBMIT: 'mde_equation_submit',
        LIBRARY: 'mde_equation_library',
        LIBRARY_GROUPS: 'mde_equation_groups',
        LIBRARY_GROUP_PREFIX: 'mde_equation_group'
    },
    SELECTORS = {
        LIBRARY: '.' + CSS.LIBRARY,
...
Y.namespace('M.mde_equation').Button = Y.Base.create('button', Y.M.editor_mde.EditorPlugin, [], {
    ...
    initializer: function() {
        ...
        if (this.get('texfilteractive')) {
            ...
            this.get('host').on('mde:selectionchanged', function() {
    ...
    _setEquation: function(e) {
        ...
        input = e.currentTarget.ancestor('.mde_form').one('textarea');
    ...
    _updatePreview: function(e) {
        ...
        url = M.cfg.wwwroot + '/lib/editor/mde/plugins/equation/ajax.php';
        params = {
    ...
    _getLibraryContent: function() {
        ...
        Y.Handlebars.registerHelper('split', function(delimiter, str, options) {
            ...
            if (typeof delimiter === "undefined" || typeof str === "undefined") {
                Y.log('Handlebars split helper: String and delimiter are required.', 'debug', 'moodle-mde_equation-button');
                return '';
            }
        ...
        var url = M.cfg.wwwroot + '/lib/editor/mde/plugins/equation/ajax.php';
        var params = {
            sesskey: M.cfg.sesskey,
            contextid: this.get('contextid'),
            action: 'filtertext',
