YUI.add('moodle-editor_mde-editor', function (Y, NAME) {
...
/**
 * The mde WYSIWG pluggable editor, written for Moodle.
 *
 * @module     moodle-editor_mde-editor
 * @package    editor_mde
 * @copyright  2013 Damyon Wiese  <damyon@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @main       moodle-editor_mde-editor
 */
...
var LOGNAME = 'moodle-editor_mde-editor';
var CSS = {
        CONTENT: 'editor_mde_content',
        CONTENTWRAPPER: 'editor_mde_content_wrap',
        TOOLBAR: 'editor_mde_toolbar',
        WRAPPER: 'editor_mde',
        HIGHLIGHT: 'highlight'
    },
    rangy = window.rangy;
...
/**
 * The mde editor for Moodle.
 *
 * @namespace M.editor_mde
 * @class Editor
 * @constructor
 * @uses M.editor_mde.EditorClean
 * @uses M.editor_mde.EditorFilepicker
 * @uses M.editor_mde.EditorSelection
 * @uses M.editor_mde.EditorStyling
 * @uses M.editor_mde.EditorTextArea
 * @uses M.editor_mde.EditorToolbar
 * @uses M.editor_mde.EditorToolbarNav
 */
...
Y.extend(Editor, Y.Base, {
    ...
    PLACEHOLDER_CLASS: 'mde-tmp-class',
    ...
    initializer: function() {
        ...
        var description = Y.Node.create('<div class="sr-only">' + M.util.get_string('richtexteditor', 'editor_mde') + '</div>');
        ...
        this.textarea.get('parentNode').insert(this._wrapper, this.textarea).
                setAttribute('class', 'editor_mde_wrap');
    ...
    publishEvents: function() {
        ...
        this.publish('mde:selectionchanged', {
            prefix: 'mde'
        });
    ...
    setupPlugins: function() {
        ...
        for (groupIndex in plugins) {
            ...
            for (pluginIndex in group.plugins) {
                ...
                if (typeof Y.M['mde_' + plugin.name] === "undefined") {
                    Y.log("Plugin '" + plugin.name + "' could not be found - skipping initialisation", "warn", LOGNAME);
                    continue;
                }
                this.plugins[plugin.name] = new Y.M['mde_' + plugin.name].Button(pluginConfig);
            }
        }
...
Y.namespace('M.editor_mde').Editor = Editor;

// Function for Moodle's initialisation.
Y.namespace('M.editor_mde.Editor').init = function(config) {
    return new Y.M.editor_mde.Editor(config);
};
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
...
/**
 * A notify function for the mde editor.
 *
 * @module     moodle-editor_mde-notify
 * @submodule  notify
 * @package    editor_mde
...
var LOGNAME_NOTIFY = 'moodle-editor_mde-editor-notify',
    NOTIFY_INFO = 'info',
...
EditorNotify.prototype = {
    ...
    /**
     * Show a notification in a floaty overlay somewhere in the mde editor text area.
     *
     * @method showMessage
    ...
    showMessage: function(message, type, timeout) {
        ...
        if (this.messageOverlay === null) {
            this.messageOverlay = Y.Node.create('<div class="editor_mde_notification"></div>');
        ...
        // Convert class to mde_info (for example).
        type = 'mde_' + type;
        ...
        this.hideTimer = Y.later(intTimeout, this, function() {
            Y.log('Hide mde notification.', 'debug', LOGNAME_NOTIFY);
            this.hideTimer = null;
...
Y.Base.mix(Y.M.editor_mde.Editor, [EditorNotify]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * Textarea functions for the mde editor.
 *
 * See {{#crossLink "M.editor_mde.Editor"}}{{/crossLink}} for details.
 *
 * @namespace M.editor_mde
...
Y.Base.mix(Y.M.editor_mde.Editor, [EditorTextArea]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * A autosave function for the mde editor.
 *
 * @module     moodle-editor_mde-autosave
...
var SUCCESS_MESSAGE_TIMEOUT = 5000,
    ...
    LOGNAME_AUTOSAVE = 'moodle-editor_mde-editor-autosave';
...
EditorAutosave.prototype = {
        ...
        this.autosaveIo(params, this, {
            success: function(response) {
                ...
                if (response.error || typeof response.result === 'undefined') {
                    ...
                    this.showMessage(M.util.get_string('errortextrecovery', 'editor_mde'),
    ...
    recoverText: function(text) {
        ...
        this.showMessage(M.util.get_string('textrecovered', 'editor_mde'),
    ...
    saveDraft: function() {
        ...
        if (newText !== this.lastText) {
            ...
            var ajaxErrorFunction = function(response) {
                ...
                this.showMessage(M.util.get_string('autosavefailed', 'editor_mde'), NOTIFY_WARNING, errorDuration);
            };
            ...
            this.autosaveIo(params, this, {
                ...
                success: function(response) {
                    if (response && response.error) {
                        ...
                        this.showMessage(M.util.get_string('autosavesucceeded', 'editor_mde'),
...
Y.Base.mix(Y.M.editor_mde.Editor, [EditorAutosave]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
 ...
 * A autosave function for the mde editor.
 *
 * @module     moodle-editor_mde-autosave-io
...
EditorAutosaveIoDispatcher.ATTRS = {
     ...
     * @type String
     * @default '/lib/editor/mde/autosave-ajax.php'
     * @readOnly
     */
    autosaveAjaxScript: {
        value: '/lib/editor/mde/autosave-ajax.php',
        readOnly: true
    },
...
Y.Base.mix(Y.M.editor_mde.Editor, [EditorAutosaveIo]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * Functions for the mde editor to clean the generated content.
 *
 * See {{#crossLink "M.editor_mde.Editor"}}{{/crossLink}} for details.
 *
 * @namespace M.editor_mde
...
EditorClean.prototype = {
    ...
    getCleanHTML: function() {
        ...
        editorClone.all('.mde_control').remove(true);
    ...
    fallbackPasteCleanup: function() {
        Y.log('Using fallbackPasteCleanup for mde cleanup', 'debug', LOGNAME);
...
Y.Base.mix(Y.M.editor_mde.Editor, [EditorClean]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * Selection functions for the mde editor.
 *
 * See {{#crossLink "M.editor_mde.Editor"}}{{/crossLink}} for details.
 *
 * @namespace M.editor_mde
...
Y.Base.mix(Y.M.editor_mde.Editor, [EditorCommand]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * Toolbar functions for the mde editor.
 *
 * See {{#crossLink "M.editor_mde.Editor"}}{{/crossLink}} for details.
 *
 * @namespace M.editor_mde
...
Y.Base.mix(Y.M.editor_mde.Editor, [EditorToolbar]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * Toolbar Navigation functions for the mde editor.
 *
 * See {{#crossLink "M.editor_mde.Editor"}}{{/crossLink}} for details.
 *
 * @namespace M.editor_mde
    ...
    checkTabFocus: function() {
        if (this._tabFocus) {
            if (this._tabFocus.hasAttribute('disabled') || this._tabFocus.hasAttribute('hidden')
                    || this._tabFocus.ancestor('.mde_group').hasAttribute('hidden')) {
...
Y.Base.mix(Y.M.editor_mde.Editor, [EditorToolbarNav]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
EditorSelection.prototype = {
    ...
    setupSelectionWatchers: function() {
        ...
        this.on('mde:selectionchanged', this.saveSelection, this);
     ...
     *
     * Should be used in combination with {{#crossLink "M.editor_mde.EditorSelection/restoreSelection"}}{{/crossLink}}.
     *
     ...
     *
     * Should be used in combination with {{#crossLink "M.editor_mde.EditorSelection/saveSelection"}}{{/crossLink}}.
     *
     ...
     *
     * If the selection has changed, the mde:selectionchanged event is also fired.
     *
    ...
    /**
     * Fires the mde:selectionchanged event.
     *
    ...
    _fireSelectionChanged: function(e) {
        this.fire('mde:selectionchanged', {
            event: e,
            selectedNodes: this.getSelectedNodes()
        });
    },
...
Y.Base.mix(Y.M.editor_mde.Editor, [EditorSelection]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * Editor styling functions for the mde editor.
 *
 * See {{#crossLink "M.editor_mde.Editor"}}{{/crossLink}} for details.
 *
 * @namespace M.editor_mde
...
Y.Base.mix(Y.M.editor_mde.Editor, [EditorStyling]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * Filepicker options for the mde editor.
 *
 * See {{#crossLink "M.editor_mde.Editor"}}{{/crossLink}} for details.
 *
 * @namespace M.editor_mde
...
Y.Base.mix(Y.M.editor_mde.Editor, [EditorFilepicker]);
