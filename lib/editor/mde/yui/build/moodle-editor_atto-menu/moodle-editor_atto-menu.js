YUI.add('moodle-editor_mde-menu', function (Y, NAME) {
...
/**
 * A Menu for the mde editor.
 *
 * @module     moodle-editor_mde-menu
 * @submodule  menu-base
 * @package    editor_mde
...
var LOGNAME = 'moodle-editor_mde-menu';
var MENUDIALOGUE = '' +
        '<div class="open {{config.buttonClass}} mde_menu" ' +
            ...
            '<ul class="dropdown-menu" role="menu" id="{{config.buttonId}}_menu" aria-labelledby="{{config.buttonId}}">' +
                '{{#each config.items}}' +
                    '<li role="none" class="mde_menuentry">' +
...
/**
 * A Menu for the mde editor used in Moodle.
 *
...
Y.extend(Menu, M.core.dialogue, {
    ...
    initializer: function(config) {
        ...
        bb.addClass('editor_mde_controlmenu');
        bb.addClass('editor_mde_menu');
    ...
    _setupHandlers: function() {
        ...
        this._menuHandlers.push(
            ...
            contentBox.delegate('key', this._chooseMenuItem, '32, enter', '.mde_menuentry', this),
...
Y.namespace('M.editor_mde').Menu = Menu;
