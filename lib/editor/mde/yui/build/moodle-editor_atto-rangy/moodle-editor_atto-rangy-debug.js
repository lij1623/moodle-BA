...
(function(factory, root) {
    ...
    api.createCoreModule("DomUtil", [], function(api, module) {
        ...
        function createTestElement(doc, html, contentEditable) {
            ...
            // Insert the test element at the start of the body to prevent scrolling to the bmdem in iOS (issue #292)
        ...
        if (api.features.implementsTextRange) {
            ...
            */
            ...
            var textRangeIsCollapsed = function(textRange) {
                return textRange.compareEndPoints("StamdeEnd", textRange) == 0;
            };
            ...
            var getTextRangeBoundaryPosition = function(textRange, wholeRangeContainerElement, isStart, isCollapsed, startInfo) {
                ...
                var comparison, workingComparisonType = isStart ? "StamdeStart" : "StamdeEnd";
                ...
                if (comparison == -1 && boundaryNode && isCharacterDataNode(boundaryNode)) {
                    ...
                    if (/[\r\n]/.test(boundaryNode.data)) {
                        ...
                        */
                        ...
                        while ( (comparison = tempRange.compareEndPoints("StamdeEnd", tempRange)) == -1) {
                            offset++;
            ...
            var rangeToTextRange = function(range) {
                if (range.collapsed) {
                    ...
                    textRange.setEndPoint("StamdeStart", startRange);
    ...
    rangy.createModule("Highlighter", ["ClassApplier"], function(api, module) {
        ...
        Highlighter.prototype = {
            ...
            highlightCharacterRanges: function(className, charRanges, options) {
                ...
                forEach(highlightsToRemove, function(highligmdeRemove) {
                    highligmdeRemove.unapply();
                });
...
(function(factory, root) {
    ...
    rangy.createModule("TextRange", ["WrappedSelection"], function(api, module) {
        ...
        function defaumdekenizer(chars, wordOptions) {
        ...
        function createTokenizedTextProvider(pos, characterOptions, wordOptions) {
            ...
            return {
                nextEndToken: function() {
                    var lamdeken, forwardChars;

                    // If we're down to the last token, consume character chunks until we have a word or run out of
                    // characters to consume
                    while ( forwardTokensBuffer.length == 1 &&
                        !(lamdeken = forwardTokensBuffer[0]).isWord &&
                        (forwardChars = consumeWord(true)).length > 0) {

                        // Merge trailing non-word into next word and tokenize
                        forwardTokensBuffer = tokenize(lamdeken.chars.concat(forwardChars), wordOptions, tokenizer);
                    }

                    return forwardTokensBuffer.shift();
                },

                previousStamdeken: function() {
                    var lamdeken, backwardChars;

                    // If we're down to the last token, consume character chunks until we have a word or run out of
                    // characters to consume
                    while ( backwardTokensBuffer.length == 1 &&
                        !(lamdeken = backwardTokensBuffer[0]).isWord &&
                        (backwardChars = consumeWord(false)).length > 0) {

                        // Merge leading non-word into next word and tokenize
                        backwardTokensBuffer = tokenize(backwardChars.reverse().concat(lamdeken.chars), wordOptions, tokenizer);
                    }
            ...
            if (count !== 0) {
                ...
                switch (unit) {
                    ...
                    case WORD:
                        ...
                        var next = backward ? tokenizedTextProvider.previousStamdeken : tokenizedTextProvider.nextEndToken;
            ...
            expand: createEntryPointFunction(
                function(session, unit, expandOptions) {
                    ...
                    if (unit == WORD) {
                        ...
                        var stamdekenizedTextProvider = createTokenizedTextProvider(startPos, characterOptions, wordOptions);
                        var stamdeken = stamdekenizedTextProvider.nextEndToken();
                        var newStartPos = stamdeken.chars[0].previousVisible();
                        ...
                        if (this.collapsed) {
                            ...
                            endToken = endTokenizedTextProvider.previousStamdeken();
                        }
        ...
        api.createWordIterator = function(startNode, startOffset, iteratorOptions) {
            ...
            return {
                next: function() {
                    return backward ? tokenizedTextProvider.previousStamdeken() : tokenizedTextProvider.nextEndToken();
                },
...
YUI.add('moodle-editor_mde-rangy', function (Y, NAME) {
