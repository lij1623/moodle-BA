...
/**
 * Strings for component 'editor_mde', language 'en'.
 *
 * @package    editor_mde
...
$string['autosavefrequency_desc'] = 'This is the number of seconds between auto save attempts. mde will automatically save the text in the editor according to this setting, so that text can be automatically restored when the same user returns to the same form.';
...
$string['pluginname'] = 'mde HTML editor';
$string['richtexteditor'] = 'Rich text editor';
$string['subplugintype_mde'] = 'mde plugin';
$string['subplugintype_mde_plural'] = 'mde plugins';
$string['settings'] = 'mde toolbar settings';
...
$string['privacy:metadata:database:mde_autosave'] = 'Automatically saved text editor drafts.';
$string['privacy:metadata:database:mde_autosave:userid'] = 'The ID of the user whose data was saved.';
$string['privacy:metadata:database:mde_autosave:drafttext'] = 'The text which was saved.';
$string['privacy:metadata:database:mde_autosave:timemodified'] = 'The time that content was modified.';
