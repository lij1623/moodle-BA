...
class autosave_cleanup_task extends scheduled_task {
    ...
    public function get_name() {
        return get_string('taskautosavecleanup', 'editor_mde');
    }
    ...
    public function execute() {
        ...
        $DB->delete_records_select('editor_mde_autosave', 'timemodified < :before', array('before' => $before));
    }
