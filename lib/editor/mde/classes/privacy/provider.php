...
/**
 * Privacy Subsystem implementation for editor_mde.
 *
 * @package    editor_mde
...
class provider implements
        // The mde editor stores user provided data.
        \core_privacy\local\metadata\provider,
        // The mde editor provides data directly to core.
        \core_privacy\local\request\plugin\provider,
        // The mde editor is capable of determining which users have data within it.
        \core_privacy\local\request\core_userlist_provider {

    /**
     * Returns information about how editor_mde stores its data.
     *
    ...
    public static function get_metadata(collection $collection) : collection {
        ...
        $collection->add_database_table('editor_mde_autosave', [
                'userid' => 'privacy:metadata:database:mde_autosave:userid',
                'drafttext' => 'privacy:metadata:database:mde_autosave:drafttext',
                'timemodified' => 'privacy:metadata:database:mde_autosave:timemodified',
            ], 'privacy:metadata:database:mde_autosave');
    ...
    public static function get_contexts_for_userid(int $userid) : \core_privacy\local\request\contextlist {
        ...
        $sql = "SELECT contextid FROM {editor_mde_autosave} WHERE userid = :userid";
    ...
    public static function delete_data_for_all_users_in_context(\context $context) {
        ...
        $DB->delete_records('editor_mde_autosave', [
                'contextid' => $context->id,
            ]);
    }
    ...
    public static function delete_data_for_users(approved_userlist $userlist) {
        ...
        $DB->delete_records_select('editor_mde_autosave', "contextid = :contextid AND userid {$useridsql}",
            $params);
    }
    ...
    public static function delete_data_for_user(approved_contextlist $contextlist) {
        ...
        $sql = "SELECT * FROM {editor_mde_autosave} WHERE contextid {$contextsql}";
        $autosaves = $DB->delete_records_select('editor_mde_autosave', "userid = :userid AND contextid {$contextsql}",
                $contextparams);
    }
