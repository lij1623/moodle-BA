 ...
 */
namespace editor_mde\plugininfo;
...
class mde extends base {
    ...
    public static function get_manage_url() {
        return new \moodle_url('/admin/settings.php', array('section'=>'editorsettingsmde'));
    }
     ...
     * It's used to get the setting links in the mde sub-plugins table.
     *
     * @return null|string the settings section name.
     */
    public function get_settings_section_name() {
        return 'mde_' . $this->name . '_settings';
    }
}
